...
report_test_() ->
    ...
    [{"compile ok text",
     ...
     {"compile ok json",
      fun() ->
              Expected = #{path => <<"testing.erl">>,
                           warnings => []},
              Actual = format({ok, {"testing.erl", testing, []}}, json),
              ?assertEqual(Expected, Actual)
      end},
     {"compile with warnings text",
      fun() ->
              Expected = ["compiled ","testing.erl",
                           [$\n,
     ...
     {"compile with warnings json",
      fun() ->
              Expected = #{path => <<"testing.erl">>,
                           warnings => [<<"testing.erl:36: Warning: variable 'Errors' is unused">>,
                                        <<"testing.erl:36: Warning: variable 'Warnings' is unused">>,
                                        <<"testing.erl:194: Warning: no clause will ever match">>,
                                        <<"testing.erl:194: Warning: the guard for this clause evaluates to 'false'">>]},
     ...
     {"compile error with warnings text",
      fun() ->
              Expected = ["ERROR ","testing1"," ", $\n,
                           <<"\n">>, $\n,
                           ["Warnings",$\n,
     ...
     {"compile error with warnings json",
      fun() ->
              Expected = #{path => <<"testing1">>,
                           errors => [],
                           warnings =>
